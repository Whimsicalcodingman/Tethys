<template>
  <footer class="bg-white border-t border-gray-200 py-12">
    <div class="container mx-auto px-6 sm:max-w-4xl">
      <!-- Footer Branding -->
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">
          Your go-to platform for movie reviews and insights.
        </p>
      </div>
      ...
      <div class="mt-8 text-center text-gray-500 text-xs">
        &copy; 2025 Movies App. Made with love by Ims Storm van Leeuwen.
      </div>
    </div>
  </footer>
</template>
